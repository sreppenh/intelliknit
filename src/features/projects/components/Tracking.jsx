              ...
              <div className="stack-sm">
                {activeComponent.steps.map((step, stepIndex) => {
                  ...
                  return (
                    <div
                      key={step.id}
                      className={`border rounded-lg p-4 transition-all ${isCurrentStep && !isCompleted
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 text-left">
                          <div className="flex justify-between items-start mb-1">
                            <span className={`text-sm font-medium ${isCurrentStep && !isCompleted ? 'text-green-800' : 'text-gray-700'
                              }`}>
                              Step {stepIndex + 1}
